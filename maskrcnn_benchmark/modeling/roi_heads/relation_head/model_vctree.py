...
class VCTreeLSTMContext(nn.Module):
    ...
    def forward(self, x, proposals, rel_pair_idxs, logger=None, all_average=False, ctx_average=False):
        ...
        # vc_forest = rebuild_forest(vc_forest, proposals)
    ...
    def vctree_score_net(self, num_objs, roi_feat, roi_dist, proposals):
        ...
        # def print_grad(grad):
        #     print('co-prior grad\n',grad)
        # def print_vis_prior(grad):
        #     print('vis_prior grad\n', grad)
        #
        # def print_logit_prior(grad):
        #     print('joint_logit grad\n', grad)
        ...
        for sub, obj, dist, prp in zip(sub_feats, obj_feats, roi_dists, proposals):
            ...
            # co_prior.register_hook(print_grad)
            # vis_prior.register_hook(print_vis_prior)
            # joint_pred.register_hook(print_logit_prior)
