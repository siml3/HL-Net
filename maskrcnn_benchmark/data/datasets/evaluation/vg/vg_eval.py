...
from maskrcnn_benchmark.data.datasets.evaluation.vg.sgg_eval import SGRecall, SGZeroShotRecall, SGMeanRecall, SGMeanMicroRecall
...
def do_vg_evaluation(
    ...
    if "relations" in iou_types:
        ...
        eval_recall = SGRecall(cfg, result_dict)
